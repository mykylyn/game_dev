...
while running:
    ...
    # draws a rectangle on the screen that's "black"
    # takes in a Rect object that contains the following info
    # x = 100
    # y = 200
    # width = 400
    # height = 25
    pygame.draw.rect(screen, "black", pygame.Rect(100,200,400,25))
