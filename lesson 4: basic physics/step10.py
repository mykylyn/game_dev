...
def player_colliding(player, blocks):
    for block in blocks:
...
blocks = [
    pygame.Rect(20,500,400,25),
    pygame.Rect(500,450,25,100),
    pygame.Rect(700,400,400,25),
    pygame.Rect(800,300,50,25),
    pygame.Rect(1000,200,50,25),
    pygame.Rect(800,100,50,25),
]
...
while running:
    ...
    if keys[pygame.K_SPACE] and player_grounded:
        player_vel_y -= 8
    ...
    if player_vel_x > 0:
        ...
        while (player_colliding(player, blocks)):
            player.x -= 1
    else:
    ...
    # reset the grounded variable so it can be set, or not set, to True in the collision code
    player_grounded = False
